...
INSERT INTO WORKOUT (name, workout_type, minutes) VALUES ("Katrina", "running", 50);
INSERT INTO WORKOUT (name, workout_type, minutes) VALUES ("Mel", "jumping", 15);
INSERT INTO WORKOUT (name, workout_type, minutes) VALUES ("Don", "running", 30);
INSERT INTO WORKOUT (name, workout_type, minutes) VALUES ("Deb", "swimming", 60);

UPDATE WORKOUT set name = "Donny"
WHERE id = 3;
